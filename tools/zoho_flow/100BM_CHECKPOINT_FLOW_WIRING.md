...
| FT Invite Date | `FT_Invite_Date` | Original invite — **never changed** by attendance |
| FT Attended Date | `FT_attended_date` | Set to **session date** whenever status is written (**Yes / No / Absent**); invite date unchanged |
